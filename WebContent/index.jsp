...
<html lang="es" xmlns:ng="http://angularjs.org" id="ng-app" ng-app=FrmMainApp> 
	<head>		
	    ...
	    <script  src="WebResources/facturacion/procedimiento/ProcedimientoController.js"></script>
	    <script  src="WebResources/facturacion/procedimiento/ProcedimientoService.js"></script>
